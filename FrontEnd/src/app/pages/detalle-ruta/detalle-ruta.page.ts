...
import { darkStyle } from '../buscar-ruta/map-dark-style';
import { DOCUMENT } from '@angular/common';
import { ConferenceData } from '../../providers/conference-data';
import { AlertController, LoadingController, ModalController, ToastController, Config, NavParams } from '@ionic/angular';
...
export class DetalleRutaPage implements OnInit {
  ...
  constructor(
   @Inject(DOCUMENT) private doc: Document,
    ...
    private verRutaService: VerRutasServices,
